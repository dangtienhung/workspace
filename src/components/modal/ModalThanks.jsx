  ...
  return (
    ...
    >
      ...
      <div className="max-w-[434px] mx-auto flex flex-col items-center justify-center text-center">
        ...
        <h2 className="my-5 text-[22px] font-semibold">Thank’s for backing campaign!</h2>
        <p className="mb-6 text-sm text-text3">
          Thank you so much for your support. We are so grateful to have the best backers on the
          planet.
        </p>
